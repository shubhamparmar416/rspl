...
use App\Http\Controllers\KYCUPDATEDController;
...
Route::prefix('user')->group(function () {
    ...
    Route::get('/kyc2', [KYCUPDATEDController::class, 'kyc2'])->name('user.kycupdated.kyc2');
    ...
    Route::group(['middleware' => ['otp', 'banuser']], function () {
        ...
        Route::group(['middleware' => 'kyc:Loan'], function () {
            ...
            Route::get('/pending-loan-accept/{id}', [UserLoanController::class, 'pendingLoanAccept'])->name('pending.loan.accept');
        });
