            ...
            if (is_null($deposit)) {
                ...
                if ($charges != null && isset($charges)) {
                    ...
                    if ($otherCharges) {
                        ...
                        $chargesEmi->emi_charges = $otherCharges;
                        $chargesEmi->next_installment = $loan->next_installment;
                        $chargesEmi->prev_installment = $prev_installment;
                        $chargesEmi->save();
                    }
                }
            }
