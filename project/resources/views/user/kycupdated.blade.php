...
<body>
                ...
                <div class="col-lg-6 offset-lg-3 p-sm-0">
                    <div class="ugf-form">
                        ...
                        <form action="" id="step_2_form" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="input-block">
                                <!-- Navigation buttons -->
                                <button type="button" style="display: none;" class="btn upload-step" onclick="uploadStetmentApi('stetment');">Submit</button><br><br>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.next-step').on('click', function () {
                ...
                formData.append('current_address',$('#current-address').val());

                //console.log(document.getElementById('upload-input-1').files[0]);
                //console.log(document.getElementById('upload-input-2').files[0]);
    ...
    <script>
        ...
        function verifyDocApi(type) {
            ...
            if (type == 'pan' && $("#pan-number").val().length == 10) {
                $("#backgroundimage").show();
                $(".container").hide();
            }
            if(document!=""){
        ...
        function openPopup(popupUrl) {
            ...
            win = window.open(popupUrl, 'Example_window', 'height=' + popHeight + ',width=' + popWidth + ',resizeable=0, top=' + popTop + ', left=' + popLeft);
            win.focus();
