...
<div class="card">
	...
	<h5 class=" mb-0 text-gray-800 pl-3">{{ __('Rejected Loans') }}</h5>
	<ol class="breadcrumb py-0 m-0">
		<li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
		<li class="breadcrumb-item"><a href="{{ route('admin.loan.rejected') }}">{{ __('Rejected Loans') }}</a></li>
	</ol>
	</div>
</div>
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
           ...
           serverSide: true,
           searching: false,
           ajax: '{{ route('admin.loan.datatables',['status'=> 2]) }}',
           columns: [
