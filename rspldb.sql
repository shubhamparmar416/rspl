...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 06, 2024 at 11:06 AM
...
CREATE TABLE IF NOT EXISTS `balance_transfers` (
  ...
  `other_bank_id` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `counters` (
  ...
  `is_money` tinyint NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `dps_plans` (
  ...
  `installment_interval` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `generalsettings` (
  ...
  `title` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_no_prefix` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `twilio_account_sid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `twilio_auth_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `twilio_default_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `twilio_status` tinyint NOT NULL DEFAULT '0',
  `nexmo_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nexmo_secret` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nexmo_default_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `is_cookie` tinyint NOT NULL DEFAULT '1',
  `cookie_button` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `module_section` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `user_module` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
DROP TABLE IF EXISTS `installment_logs`;
...
CREATE TABLE IF NOT EXISTS `money_requests` (
  ...
  `cost` double DEFAULT NULL,
  `amount` double DEFAULT NULL,
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '1 == success\r\n0 == pending',
  `details` text,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(148, NULL, 125, NULL, NULL, NULL, 0, '2024-01-30 11:24:27', '2024-01-30 11:24:27');
...
CREATE TABLE IF NOT EXISTS `other_banks` (
  ...
  `monthly_total_transaction` int NOT NULL DEFAULT '0' COMMENT 'Count',
  `daily_total_transaction` int NOT NULL DEFAULT '0' COMMENT 'Count',
  ...
  `required_information` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `pagesettings` (
  ...
  `hero_btn_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hero_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hero_photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `review_blog` tinyint(1) NOT NULL DEFAULT '1',
  `pricing_plan` tinyint(1) NOT NULL DEFAULT '0',
  `service_subtitle` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `service_title` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `service_text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `plan_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `quick_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quick_subtitle` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quick_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quick_photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `quick_background` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `faq_subtitle` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `about_attributes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `strategy_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `strategy_details` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `strategy_banner` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `app_banner` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `app_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `app_details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `app_store_photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `app_store_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `app_google_store` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `app_google_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `home_module` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `save_accounts`;
CREATE TABLE IF NOT EXISTS `save_accounts` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int DEFAULT NULL,
  `receiver_id` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `kyc_info` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `kyc_reject_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
(125, 1, 'GS24305425276132', 'shubham', NULL, NULL, NULL, NULL, '7869406981', NULL, 'shubhamparmar416@gmail.com', '$2y$10$VpDy19vqOiwqTliNvfKFcO5QND/D1DwU2ILwqtq6116m6jgmJPo0i', NULL, '2024-01-30 11:24:25', '2024-01-30 11:24:25', 0, 0, '44effd0a9510399cc437193e6e6687f3', 'Yes', 0, '19ed586594de05ecae7f2ec164781170', 0, 0, NULL, 0, NULL, 0, NULL, NULL, 0, '2024-02-29 11:24:25');
...
DROP TABLE IF EXISTS `user_dps`;
CREATE TABLE IF NOT EXISTS `user_dps` (
  `id` int NOT NULL AUTO_INCREMENT,
  `transaction_no` varchar(255) DEFAULT NULL,
  `user_id` int DEFAULT NULL,
  `dps_plan_id` int DEFAULT NULL,
  `per_installment` decimal(10,0) DEFAULT NULL,
  `installment_interval` int DEFAULT NULL,
  ...
  `interest_rate` decimal(10,0) DEFAULT NULL,
  `status` tinyint DEFAULT NULL COMMENT '1 == running, 2 == matured',
  `is_given` tinyint NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `user_fdrs`;
CREATE TABLE IF NOT EXISTS `user_fdrs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `transaction_no` varchar(255) DEFAULT NULL,
  `user_id` int DEFAULT NULL,
  `fdr_plan_id` int DEFAULT NULL,
  `amount` double DEFAULT NULL,
  ...
  `status` tinyint DEFAULT NULL COMMENT '1 == running, 2 == closed',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `user_loans` (
  ...
  `total_installment` int DEFAULT NULL,
  `given_installment` int DEFAULT NULL,
  `paid_amount` decimal(20,10) DEFAULT NULL,
  `total_amount` decimal(20,10) DEFAULT NULL,
  `required_information` longtext,
  `next_installment` timestamp NULL DEFAULT NULL,
  `status` tinyint DEFAULT '0' COMMENT '0 == pending , 1 == approve , 2 == rejected, 3 == completed,',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `wire_transfers` (
  ...
  `transaction_no` varchar(255) DEFAULT NULL,
  `user_id` int DEFAULT NULL,
  `wire_transfer_bank_id` int DEFAULT NULL,
...
DROP TABLE IF EXISTS `wire_transfer_banks`;
CREATE TABLE IF NOT EXISTS `wire_transfer_banks` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL,
  `currency_id` int DEFAULT NULL,
